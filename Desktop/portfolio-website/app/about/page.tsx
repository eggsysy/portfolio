    ...
    <div className="min-h-screen bg-soft-lavender dark:bg-[#0d0d18] pt-20 pb-16 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute top-32 -left-16 w-64 h-48 bg-white dark:bg-gray-800 rounded-3xl shadow-lg transform rotate-12 opacity-60 dark:opacity-10"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="relative inline-block">
              <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 relative z-10">Skills & Expertise</h2>
              <div
        ...
        >
          ...
          <div className="text-center mb-12">
            <div className="relative inline-block">
              <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-100 relative z-10">Beyond Code</h2>
              <div
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {interests.map((interest, index) => (
              ...
              >
                <Card
                  className="bg-white dark:bg-gray-900 border-0 dark:border dark:border-gray-700/50 shadow-lg hover:shadow-xl transition-all duration-300 p-6 relative overflow-hidden transform group-hover:-rotate-1"
