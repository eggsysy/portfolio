    ...
    <div className="min-h-screen bg-soft-lavender dark:bg-[#0d0d18] pt-20 pb-16 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className="absolute top-28 -left-16 w-60 h-44 bg-white dark:bg-gray-800 rounded-2xl shadow-lg transform rotate-12 opacity-50 dark:opacity-10"
          ...
          >
            <CardContent className="p-8">
              <div className="relative inline-block mb-6">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 relative z-10">Continuous Learning Journey</h2>
                <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <motion.div whileHover={{ scale: 1.05, rotate: 1 }}>
              <div
                ...
                style={{ clipPath: "polygon(5% 0%, 95% 5%, 100% 95%, 0% 100%)" }}
              >
                <div className="text-3xl font-bold text-bright-aqua mb-2">{certifications.length}</div>
