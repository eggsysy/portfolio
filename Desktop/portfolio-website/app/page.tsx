    ...
    <div className="min-h-screen relative overflow-hidden bg-soft-lavender dark:bg-[#0d0d18] transition-colors duration-300">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-20 -left-20 w-96 h-64 bg-white dark:bg-gray-800 rounded-[40px] shadow-lg transform rotate-12 opacity-80 dark:opacity-10"
          style={{
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="relative inline-block">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-gray-100 relative z-10">My Mission</h2>
              <div
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <div
                   className="bg-white dark:bg-gray-900 p-8 shadow-xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden"
                  style={{
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
               <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-100 mb-6">Ready to Build Something Amazing?</h2>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center h-full">
               <span
                 className="text-gray-800 dark:text-gray-200 font-bold text-xl transform -rotate-3"
                style={{
