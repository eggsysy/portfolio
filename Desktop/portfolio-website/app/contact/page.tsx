      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative">
            <div
              className="bg-white dark:bg-gray-800 shadow-md transform rotate-1 h-12 mx-8"
              style={{ clipPath: "polygon(3% 0%, 97% 2%, 99% 98%, 1% 100%)" }}
            />
            <div
              className="bg-soft-lavender dark:bg-gray-900 shadow-sm transform -rotate-1 h-8 mx-12 -mt-6"
